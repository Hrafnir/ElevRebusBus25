...
document.addEventListener('DOMContentLoaded', () => {
    ...
    logToMobile("DEBUG_V40: DOMContentLoaded event fired.", "info");
    initializeSounds(); 
    ...
    function updatePageText(pageElement, teamPostNumber, globalPostId) { 
        ...
        if (postData.type === 'manned_minigolf' || postData.type === 'manned_pyramid') {
            ...
            if (geoRunSetupElement) { // Sørg for at seksjonen finnes
                const geoRunSetupInstructions = geoRunSetupElement.querySelector('p:nth-of-type(2)'); // Finner andre p-tag
    ...
    function displayFinalResults() {
        logToMobile("DEBUG_V40: Displaying final results.", "info");
    ...
    function clearState() { /* ... (som i v38, men med DEBUG_V40 i logg) ... */ }
    function resetPageUI(pageIdentifier, pageElementContext = null) { /* ... (som i v38, men med DEBUG_V40 i logg) ... */ }
    function resetAllPostUIs() { /* ... (som i v38) ... */ }
    function initializeTeam(teamCode) { /* ... (som i v38, men med DEBUG_V40 i logg) ... */ }
    ...
    if (postContentContainer) {
        postContentContainer.addEventListener('click', (event) => {
            ...
            if (target.id === 'start-with-team-code-button-dynamic' && !target.disabled) {
                ...
                // Hvis post1.js har en egen handleSubmit, bruk den, ellers fallback til global
